...
--
-- Host: localhost
-- Generation Time: Sep 09, 2022 at 10:25 AM
...
--
-- Database: `hearsmoking`
--
CREATE DATABASE IF NOT EXISTS `hearsmoking` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hearsmoking`;
...
('hs01nttpq8uncxxo9isdpw4qcfjn9bzf', 'eyJ1c2VyaWQiOjJ9:1oWb8U:mo_CkwscFWfG21kbC1ZZQJ-zGDOF86WY5_k4bSFR4nA', '2022-09-23 10:21:22.981936'),
...
('z7owbebbi40h19tt4unsgm4u4ah5rtjn', 'eyJ1c2VyaWQiOjF9:1oWaZe:QoD8YUZNtRXcJWj-Cz7BB_2CgSLYl4rgooLRwicL0Vw', '2022-09-23 09:45:22.257620'),
...
(1, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8982,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,5th Cross,Malleshwaram', 'Male');
...
(28, 'Naive Bayes', '60.7095046854083'),
(29, 'SVM', '60.7095046854083'),
(30, 'Logistic Regression', '60.7095046854083'),
(31, 'Gradient Boosting Classifier', '61.111111111111114'),
(32, 'KNeighborsClassifier', '61.111111111111114');
...
(14, 'No Smoking Detection', '42.857142857142854'),
(15, 'Smoking Detection', '57.14285714285714');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_smoking_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_smoking_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `CHASSIS_NO` varchar(300) NOT NULL,
  `MODEL_YEAR` varchar(300) NOT NULL,
  `USE_OF_VEHICLE` varchar(300) NOT NULL,
  `MODEL` varchar(300) NOT NULL,
  `MAKE` varchar(300) NOT NULL,
  `gender` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `height_cm` varchar(300) NOT NULL,
  `weight_kg` varchar(300) NOT NULL,
  `waist_cm` varchar(300) NOT NULL,
  `eyesight_left` varchar(300) NOT NULL,
  `eyesight_right` varchar(300) NOT NULL,
  `hearing_left` varchar(300) NOT NULL,
  `hearing_right` varchar(300) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;

--
-- Dumping data for table `remote_user_smoking_detection`
--

INSERT INTO `remote_user_smoking_detection` (`id`, `CHASSIS_NO`, `MODEL_YEAR`, `USE_OF_VEHICLE`, `MODEL`, `MAKE`, `gender`, `age`, `height_cm`, `weight_kg`, `waist_cm`, `eyesight_left`, `eyesight_right`, `hearing_left`, `hearing_right`, `Prediction`) VALUES
(2, 'RKLBB42E3A8003628', '2010', 'PRIVATE', 'COROLLA', 'TOYOTA', 'F', '50', '150', '60', '85', '0.7', '0.8', '1', '1', 'Smoking Detection'),
(3, 'MD2A12DZ5ECH54844', '2015', 'PRIVATE', 'PULSAR', 'BAJAJ', 'F', '40', '170', '55', '68', '1', '1', '1', '1', 'No Smoking Detection'),
(4, 'MD2A12DZXECH54872', '2015', 'PRIVATE', 'PULSAR', 'BAJAJ', 'M', '40', '180', '85', '82', '1.5', '1.5', '1', '1', 'Smoking Detection'),
(5, 'JTFHX02P270016694', '2007', 'COMMERCIAL', 'HIACE ', 'TOYOTA', 'M', '35', '170', '65', '84.6', '1', '1', '1', '1', 'No Smoking Detection'),
(6, '6T1BE42K69X543079', '2009', 'PRIVATE', 'CAMRY', 'TOYOTA', 'F', '45', '165', '60', '76', '0.7', '0.8', '1', '1', 'No Smoking Detection'),
(7, 'KNAJE552X97608137', '2009', 'PRIVATE', 'SPORTAGE', 'KIA', 'M', '55', '180', '75', '80', '0.8', '0.4', '1', '1', 'Smoking Detection'),
(8, 'JTDKW923075049537', '2007', 'PRIVATE', 'YARIS', 'TOYOTA', 'F', '40', '160', '55', '72', '0.7', '0.6', '1', '1', 'Smoking Detection');
