...
from hearsmoking import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Smoking_Detection/$', remoteuser.Predict_Smoking_Detection, name="Predict_Smoking_Detection"),
    ...
    url(r'^View_Smoking_Detection_Ratio/$', serviceprovider.View_Smoking_Detection_Ratio, name="View_Smoking_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Smoking_Detection/$', serviceprovider.View_Prediction_Of_Smoking_Detection, name="View_Prediction_Of_Smoking_Detection"),
