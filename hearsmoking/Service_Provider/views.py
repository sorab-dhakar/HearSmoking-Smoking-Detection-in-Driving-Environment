...
def View_Smoking_Detection_Ratio(request):
    ...
    return render(request, 'SProvider/View_Smoking_Detection_Ratio.html', {'objs': obj})
...
def View_Prediction_Of_Smoking_Detection(request):
    ...
    return render(request, 'SProvider/View_Prediction_Of_Smoking_Detection.html', {'list_objects': obj})
